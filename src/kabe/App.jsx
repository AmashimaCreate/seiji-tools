...
export default function App() {
  ...
  if (o.dependent && !employeeTrack) walls.push({ x: 130, name: "130万円(扶養)", tone: C.wallMoney });
  ...
  const siDetail = r.insuranceType === "employee"
    ...
    : "年収130万円未満で家族の扶養に入っているあいだは、自分で保険料を払う必要がありません(家族の保険料も増えません)。";
      ...
      <div style={S.wrap}>
        ...
        <section style={S.card}>
          ...
          <ExpandRow badge="130万" color={C.wallMoney} name="扶養の壁"
            oneLiner="家族の扶養から外れるライン。いちばん大きい壁"
            detail="配偶者や親の健康保険の扶養でいられるのは年収130万円未満まで。超えると自分で国民年金・国民健康保険(または勤め先の社会保険)に入ることになり、手取りが一時的に大きく下がります。2026年時点で実質的にいちばん大きい壁です。"
